      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6">
            <div class="block-16">
              <figure>
                <img src="images/blog.jpg" alt="Image placeholder" class="img-fluid rounded">
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="images/avatar.jpg" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Daniel Cabrales</h3>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="images/avatar.jpg" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Juan Pelaez</h3>
                  <p class="block-38-subheading"></p>
                </div>
                <div class="block-38-body">
                  <p> </p>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="images/avatar.jpg" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Antony Garcia</h3>
                  <p class="block-38-subheading"></p>
                </div>
                <div class="block-38-body">
                  <p></p>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="images/avatar.jpg" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">Juan Teatino</h3>
                  <p class="block-38-subheading"></p>
                </div>
                <div class="block-38-body">
                  <p></p>
